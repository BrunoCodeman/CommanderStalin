...
function RunResultsMenu()
  ...
  if GameResult == GameVictory then
    result = _("Victoria Soviética!")
    background = "graphics/screens/victory.png"
    SetMusicVolume(255)
    PlayMusic("music/cccp.ogg");
  elseif GameResult == GameDraw then
    result = _("Draw !")
  elseif GameResult == GameDefeat then
    result = _("Derrota Soviética!")
...
function GameStarting()
  ...
  UI.StatusLine:Set("Commander Stalin V" .. "0.1.0" ..
    ", (c) 1998-2008 by Commander Stalin and the Bos Wars and Stratagus Project.")
end
