...
local ai_loop_funcs = {
  ...
  function() return AiForce(1, {"unit-gerreg", "unit-gerpes", 8}) end,
...
local ai_funcs = {
  ...
  function() return AiSet("unit-gerobrero", 3) end,
  function() return AiNeed("unit-cancilleria") end,
  function() return AiNeed("unit-magmapump") end,
  function() return AiWait("unit-cancilleria") end,

  function() return AiNeed("unit-gercuartel") end,
  function() return AiNeed("unit-nukepowerplant") end,
  function() return AiNeed("unit-gerobrero") end,
  function() return AiNeed("unit-gerobrero") end,
  function() return AiNeed("unit-gerobrero") end,
  function() return AiNeed("unit-gerobrero") end,
  ...
  function() return AiNeed("unit-gturret") end,
  function() return AiNeed("unit-gturret") end,
  function() return AiNeed("unit-gerfabrica") end,
  function() return AiNeed("unit-magmapump") end,
  ...
  function() return AiSet("unit-gerobrero", 4) end,

  -- Defense
  function() return AiForce(0, {"unit-gerreg", 20}) end,
  ...
  -- Attack wave
  function() return AiForce(1, {"unit-gerreg", 5}) end,
  ...
  -- Bigger attack wave
  function() return AiNeed("unit-magmapump") end,
  function() return AiForce(1, {"unit-gerreg", 40, "unit-gerpes", 10, "unit-tiger1", 6}) end,
  function() return AiWaitForce(1) end, 
  function() return AiAttackWithForce(1) end,
  
    -- Bigger attack wave
  function() return AiNeed("unit-magmapump") end,
  function() return AiForce(2, {"unit-gerreg", 60, "unit-gerpes", 20, "unit-tiger1", 10}) end,
...
RegisterAi("gernivel5", "gernivel5", AiBlitz, InitAiScripts_blitz)
