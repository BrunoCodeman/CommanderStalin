...
DefineIcon({
	Name = "icon-gercuartel",
	Size = {46, 38},
	Frame = 0,
	File = GetCurrentLuaPath().."/gercuartel_i.png"})

DefineConstruction("construction-gercuartel", {
	Constructions = {
...
DefineAnimations("animations-gercuartel", {
...
DefineUnitType("unit-gercuartel", {
    Name = "Cuartel Aleman",
    Image = {"file", GetCurrentLuaPath().."/gercuartel.png", "size", {224, 224}},
    Offset = {2, -7},
    Shadow = {"file", GetCurrentLuaPath().."/gercuartel_s.png", "size", {224, 224}},
    Animations = "animations-gercuartel",
    Icon = "icon-gercuartel",
    EnergyValue = 4000,
    MagmaValue = 1000,
    RepairHp = 2,
    Construction = "construction-gercuartel",
    Speed = 0,
    HitPoints = 500,
    DrawLevel = 25,
    TileSize = {7, 5},
...
DefineAnimations("animations-dead-gercuartel", {
    Death = {"unbreakable begin", "wait 1", "frame 0", "wait 2000", 
        "frame 1", "wait 200", "frame 2", "wait 200", "frame 2", "wait 1", 
        "unbreakable end", "wait 1", },
    })

DefineUnitType("build-dead-gercuartel", {
    Name = "CampCrater",
    Image = {"file", GetCurrentLuaPath().."/gercuartel_c.png", "size", {224, 224}},
    Animations = "animations-dead-gercuartel",
    Icon = "icon-cancel",
    Speed = 0,
    HitPoints = 999,
    DrawLevel = 10,
...
DefineAllow("unit-gercuartel", AllowAll)

DefineButton({
    Pos = 1, Level = 2, Icon = "icon-camp_b", Action = "build",
    Value = "unit-gercuartel", Hint = "BUILD TRAINING ~!GERCUARTEL",
