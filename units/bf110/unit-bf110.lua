...
DefineAnimations("animations-bf110", {
...
DefineIcon({
	...
	Size = {46, 38},
	Frame = 0,
	File = "units/bf110/ico_bf110.png"})
...
DefineUnitType("unit-bf110", {
    Name = "BF-110",
    Image = {"file", "units/bf110/unit_bf110.png", "size", {128,128}},
    Shadow = {"file", "units/bf110/unit_bf110_s.png", "size", {128, 128}, "offset", {5,128}},
    Animations = "animations-bf110",
    Icon = "ico-bf110",
    EnergyValue = 7000,
    MagmaValue = 3000,
    Speed = 35,
...
DefineAllow("unit-bf110", AllowAll)

DefineButton({
    Pos = 1, Level = 0, Icon = "ico-bf110", Action = "train-unit",
    Value = "unit-bf110", Hint = "BUILD ~!BF110",
    ForUnit = {"unit-geravionfa"}})

DefineCommonButtons({"unit-bf110"})
