...
DefineIcon({
	...
	Size = {46, 38},
	Frame = 0,
	File = GetCurrentLuaPath() .. "/ico_geravionfa.png"})

DefineConstruction("construction-geravionfa", {
        Constructions = {
...
DefineAnimations("animations-geravionfa", {
...
DefineUnitType("unit-geravionfa", {
    Name = "Fábrica de aviones",
    Image = {"file", GetCurrentLuaPath() .. "/geravionfa.png", "size", {256, 256}},
    Shadow = {"file", GetCurrentLuaPath().."/geravionfa_s.png", "size",
 {256, 256}},
    Animations = "animations-geravionfa",
    Icon = "icon-dev",
    EnergyValue = 12000,
    MagmaValue = 6000,
    RepairHp = 4,
    Construction = "construction-geravionfa",
    Speed = 0,
    HitPoints = 500,
    DrawLevel = 25,
    TileSize = {7, 6},
...
DefineAnimations("animations-dead-geravionfa", {
    Death = {"unbreakable begin", "wait 1", "frame 0", "wait 2000", 
        "frame 1", "wait 200", "frame 2", "wait 200", "frame 2", "wait 1", 
        "unbreakable end", "wait 1", },
    }) 
DefineUnitType("build-dead-geravionfa", {
    Name = "aircraftfactoryCrater",
    Image = {"file", GetCurrentLuaPath().."/geravionfa_c.png", "size", {256, 256}},
...
DefineAllow("unit-geravionfa", AllowAll)

DefineButton({
    Pos = 7, Level = 2, Icon = "icon-dev_b", Action = "build",
    Value = "unit-geravionfa", Hint = "BUILD ~!geravionfa",
