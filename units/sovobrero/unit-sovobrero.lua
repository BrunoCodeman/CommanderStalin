...
DefineIcon({
	...
	Size = {46, 38},
	Frame = 0,
	File = GetCurrentLuaPath().."/ico_sovobrero.png"})

DefineAnimations("animations-sovobrero", {
...
DefineUnitType("unit-sovobrero", {
    Name = "sovobrero",
    Image = {"file", GetCurrentLuaPath().."/unit_sovobrero.png", "size", {56, 56}},
    Shadow = {"file", GetCurrentLuaPath().."/unit_sovobrero_s.png", "size", {56, 56}},
    DrawLevel = 25,
    Animations = "animations-sovobrero",
    Icon = "ico-sovobrero",
    Flip = true,
    EnergyValue = 1600,
    MagmaValue = 800,
...
DefineHumanCorpse("sovobrero", {56, 56}, true)

DefineAllow("unit-sovobrero", AllowAll)
