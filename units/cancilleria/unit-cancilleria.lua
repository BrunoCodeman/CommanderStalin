...
DefineAnimations("animations-cancilleria", {
...
DefineIcon({
        Name = "ico-cancilleria",
        Size = {46, 38},
        Frame = 0,
        File = "units/cancilleria/ico_cancilleria.png"})

DefineConstruction("construction-cancilleria", {
        Constructions = {
...
DefineUnitType("unit-cancilleria", {
    Name = "cancilleria",
    Image = {"file", "units/cancilleria/cancilleria.png", "size", {236, 208}},
    Shadow = {"file", GetCurrentLuaPath().."/cancilleria_s.png", "size", {236, 208}},
    Animations = "animations-cancilleria",
    Icon = "ico-cancilleria",
    EnergyValue = 7500,
    MagmaValue = 3800,
    RepairHp = 4,
    Construction = "construction-cancilleria",
    Speed = 0,
    HitPoints = 600,
    DrawLevel = 25,
    TileSize = {6, 6},
...
DefineAnimations("animations-dead-cancilleria", {
    Death = {"unbreakable begin", "wait 1", "frame 0", "wait 2000", 
        "frame 1", "wait 200", "frame 2", "wait 200",  "unbreakable end", "wait 1", },
    })

DefineUnitType("build-dead-cancilleria", {
    Name = "vaultCrater",
    Image = {"file", GetCurrentLuaPath().."/vault_c.png", "size", {236, 208}},
    Animations = "animations-dead-cancilleria",
    Icon = "icon-cancel",
    Speed = 0,
    HitPoints = 999,
    DrawLevel = 10,
...
DefineAllow("unit-cancilleria", AllowAll)
