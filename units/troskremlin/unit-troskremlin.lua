...
DefineAnimations("animations-troskremlin", {
...
DefineIcon({
        Name = "icon-troskremlin",
        Size = {46, 38},
        Frame = 0,
        File = "units/troskremlin/troskremlin-i.png"})

DefineConstruction("construction-troskremlin", {
        Constructions = {
...
DefineUnitType("unit-troskremlin", {
    Name = "troskremlin",
    Image = {"file", "units/troskremlin/troskremlin.png", "size", {236, 208}},
    Shadow = {"file", GetCurrentLuaPath().."/troskremlin_s.png", "size", {236, 208}},
    Animations = "animations-troskremlin",
    Icon = "icon-troskremlin",
    EnergyValue = 7500,
    MagmaValue = 3800,
    RepairHp = 4,
    Construction = "construction-troskremlin",
    Speed = 0,
    HitPoints = 600,
    DrawLevel = 25,
    TileSize = {6, 6},
...
DefineAnimations("animations-dead-troskremlin", {
    Death = {"unbreakable begin", "wait 1", "frame 0", "wait 2000", 
        "frame 1", "wait 200", "frame 2", "wait 200",  "unbreakable end", "wait 1", },
    })

DefineUnitType("build-dead-troskremlin", {
    Name = "vaultCrater",
    Image = {"file", GetCurrentLuaPath().."/troskremlin_c.png", "size", {236, 208}},
    Animations = "animations-dead-troskremlin",
    Icon = "icon-cancel",
    Speed = 0,
    HitPoints = 999,
    DrawLevel = 10,
...
DefineAllow("unit-troskremlin", AllowAll)
