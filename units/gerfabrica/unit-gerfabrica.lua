...
DefineIcon({
	Name = "icon-gerfabrica",
	Size = {46, 38},
	Frame = 0,
	File = GetCurrentLuaPath().."/gerfabrica_i.png"})

DefineConstruction("construction-gerfabrica", {
	Constructions = {
...
DefineAnimations("animations-gerfabrica", {
...
DefineUnitType("unit-gerfabrica", {
    Name = "Fábrica Alemana",
    Image = {"file", GetCurrentLuaPath().."/gerfabrica.png", "size", {256, 254}},
    Shadow = {"file", GetCurrentLuaPath().."/gerfabrica_s.png", "size", {256, 254}},
    Animations = "animations-gerfabrica",
    Icon = "icon-gerfabrica",
    EnergyValue = 6000,
    MagmaValue = 4000,
    RepairHp = 2,
    Construction = "construction-gerfabrica",
    Speed = 0,
    HitPoints = 550,
    DrawLevel = 25,
    TileSize = {7, 5},
...
DefineAnimations("animations-dead-gerfabrica", {
    Death = {"unbreakable begin", "wait 1", "frame 0", "wait 2000", 
        "frame 1", "wait 200", "frame 2", "wait 200", "frame 2", "wait 1", 
        "unbreakable end", "wait 1", },
    })

DefineUnitType("build-dead-gerfabrica", {
    Name = "FactoryCrater",
    Image = {"file", GetCurrentLuaPath().."/vehicle_c.png", "size", {256, 254}},
    Animations = "animations-dead-gerfabrica",
    Icon = "icon-cancel",
    Speed = 0,
    HitPoints = 999,
    DrawLevel = 10,
...
DefineAllow("unit-gerfabrica", AllowAll)

DefineButton({
    Pos = 3, Level = 2, Icon = "icon-vfac_b", Action = "build",
    Value = "unit-gerfabrica", Hint = "BUILD ~!GERFABRICA",
